function transformThymeToJs(tree, runtimePrefix){
  runtimePrefix = '__rt';

  var src = "";
  var rt = typeof __rt == "undefined" ? require('./thyme-runtime') : __rt;
...
if(typeof module !== "undefined"){ module.exports = transformThymeToJs; }
