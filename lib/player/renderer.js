...
Renderer.prototype.draw = function() {
  for (var i = 0, max = world.bodies.length; i < max; i++) {
    ...
    for (var j = 0; j < maxFixtures; j++) {
      ...
      fixture.shape.draw(transform, drawLineColors && body.userData ? body.userData.color : [0,0,0]);
    }
  }
...
b2PolygonShape.prototype.draw = function(transform, color) {
